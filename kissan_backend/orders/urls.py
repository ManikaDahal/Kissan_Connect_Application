...
from .views import OrderViewSet, stripe_webhook, seller_orders, update_item_status, seller_earnings, esewa_callback
...
urlpatterns = [
    ...
    path('esewa-callback/', esewa_callback, name='esewa-callback'),
